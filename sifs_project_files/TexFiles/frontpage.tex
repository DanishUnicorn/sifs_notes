\begin{titlepage}
    ...
    \begin{textblock}{9.4}(0,8)
        \Huge{\fontfamily{ptm}\selectfont\bfseries{Sustainable Innovation in Food Science}}
    \end{textblock}
    \begin{textblock}{9.4}(0,9)
        \Huge{\fontfamily{ptm}\selectfont\bfseries{NFOK20003U}}
    \end{textblock}
    ...
    \begin{textblock}{8.4}(0,16.5)
        \large{\fontfamily{ptm}\selectfont{Link to Git repo.: \url{https://github.com/DanishUnicorn/sifs_notes}}}
    \end{textblock}
